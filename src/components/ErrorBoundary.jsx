    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen w-full flex items-center justify-center bg-background-dark p-4">
          <div className="max-w-md w-full bg-card-dark border border-[#283539] rounded-2xl p-8 text-center">
            ...
            <div className="flex gap-3 justify-center">
              <button
                ...
                className="px-4 py-2 bg-[#283539] text-white rounded-lg hover:bg-[#3b4e54] transition-colors text-sm font-medium"
              >
                Reload Page
              </button>
              <button
